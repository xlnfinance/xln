...
import { bytesToHex, combineShardsWithParams, factorForShardCount } from '../../../core/index.ts';
import { BRAINVAULT_V1, createShardSalt } from '../../../core/primitives/spec.ts';
...
const cpuExecutable = '../c/brainvault-argon2-oversubscribed';
