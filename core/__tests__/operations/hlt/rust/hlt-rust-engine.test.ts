...
const rustMetrics = (overrides: Partial<RustH1Metrics> = {}): RustH1Metrics => ({
  ...
  totalProjectionEncodeMicros: 0,
  totalStoragePrepareValidateMicros: 0, totalStorageBatchBuildMicros: 0,
  totalStorageDbWriteSyncMicros: 0, totalStorageDirectorySyncMicros: 0,
  totalStoragePostCommitMicros: 0, totalBarrierWaitForPreviousCommitMicros: 0,
  totalCommitterBusyMicros: 0, totalCommitterIdleMicros: 0,
  accountCoordinatorWallMicros: 0,
...
test('Rust live telemetry isolates the economic phase and proves worker distribution', () => {
  ...
  const after = rustMetrics({
    ...
    totalStoragePrepareValidateMicros: 2, totalStorageBatchBuildMicros: 4,
    totalStorageDbWriteSyncMicros: 20, totalStorageDirectorySyncMicros: 8,
    totalStoragePostCommitMicros: 1, totalBarrierWaitForPreviousCommitMicros: 12,
    totalCommitterBusyMicros: 50, totalCommitterIdleMicros: 30,
  ...
  expect(economic).toEqual({
    ...
    storagePrepareValidateMicros: 2, storageBatchBuildMicros: 4,
    storageDbWriteSyncMicros: 20, storageDirectorySyncMicros: 8,
    storagePostCommitMicros: 1, barrierWaitForPreviousCommitMicros: 12,
    committerBusyMicros: 50, committerIdleMicros: 30,
