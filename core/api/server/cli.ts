 ...
 *
 * Usage:
 *   bun core/api/server/cli.ts                    # local anvil
 *   bun core/api/server/cli.ts remote             # xln.finance/rpc
 */
...
import { loadCliJurisdiction, type CliJurisdiction } from '../../jurisdiction/adapter/kernel/cli-jurisdiction';
