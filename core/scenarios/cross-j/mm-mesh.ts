 ...
 *
 *   bun core/scenarios/run.ts mm-mesh
 *   bun core/scenarios/run.ts mm-mesh --adversary=hub-kill
 *   bun core/scenarios/run.ts mm-mesh --adversary=mm-restart
 *
...
/**
 * Orchestrator entry used by `bun core/scenarios/run.ts mm-mesh`.
...
export async function mmMesh(_existingEnv?: RuntimeReplica): Promise<RuntimeReplica> {
  ...
  const smokePath = join(process.cwd(), 'core/scripts/operations/production/local-prod-smoke.ts');
