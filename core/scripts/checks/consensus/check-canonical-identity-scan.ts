...
for (const [path, markers] of [
  ['core/jurisdiction/machine/jurisdiction-runtime/index.ts', [
...
for (const [path, markers] of [
  ...
  ['core/__tests__/operations/health/prod-startup-wiring.test.ts', [
    "expect(hubNode).not.toContain(\"normalized === 'arrakis'\");",
  ]],
  ['core/__tests__/network/server/server-jurisdictions.test.ts', [
