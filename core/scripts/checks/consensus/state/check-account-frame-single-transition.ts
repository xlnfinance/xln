...
const file = 'core/account/consensus/index.ts';
...
const ackSource = requireSource('core/account/consensus/incoming/ack-commit.ts');
...
const transitionSource = requireSource('core/account/consensus/frame/commit-transition.ts');
...
for (const handlerFile of ts.sys.readDirectory('core/account/tx', ['.ts'])) {
