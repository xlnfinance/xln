...
const files = [
  'core/protocol/state/persistent-radix-value-build.ts',
  'core/protocol/state/persistent-radix-value-ops.ts',
  'core/protocol/state/persistent-radix-value-map.ts',
  'core/protocol/state/radix-overlay.ts',
  'core/entity/state/persistent-account-map.ts',
  'core/entity/state/persistent-collection-map.ts',
  'core/orderbook/book-overlay.ts',
] as const;
...
for (const file of ts.sys.readDirectory('core/protocol/state', ['.ts'])) {
  const text = ts.sys.readFile(file);
