...
runScan('contract governance scan', 'core/scripts/checks/contracts/check-contract-governance-scan.ts');
runScan('consensus hanko scan', 'core/scripts/checks/consensus/check-consensus-hanko-scan.ts');
runScan('runtime failure taxonomy scan', 'core/scripts/checks/consensus/check-failure-taxonomy-scan.ts');
runScan('runtime delivery boundary scan', 'core/scripts/checks/consensus/check-delivery-boundary-scan.ts');
runScan('canonical identity scan', 'core/scripts/checks/consensus/check-canonical-identity-scan.ts');
runScan('canonical fill scan', 'core/scripts/checks/consensus/check-canonical-fill-scan.ts');
runScan('swap cancel canonical scan', 'core/scripts/checks/consensus/check-swap-cancel-canonical-scan.ts');
...
for (const stale of [
  'bun core/scripts/release/run-mainnet-preflight-gate.ts --include-soak',
]) {
