 ...
 *
 * Usage:
 *   bun core/scripts/e2e/runners/run-system-tests-parallel.ts
 *   bun core/scripts/e2e/runners/run-system-tests-parallel.ts --workers=6
 *   bun core/scripts/e2e/runners/run-system-tests-parallel.ts --scenarios=processbatch,rebalance
 *   bun core/scripts/e2e/runners/run-system-tests-parallel.ts --base-port=18545 --stream
 */
...
async function main(): Promise<void> {
  if (process.argv.slice(2).some(argument => argument === '--help' || argument === '-h')) {
    console.log('Usage: bun core/scripts/e2e/runners/run-system-tests-parallel.ts [--scenarios=a,b] [--workers=N]');
    return;
  }
