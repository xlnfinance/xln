...
const printUsage = (): void => {
  console.log(`
Usage:
  bun core/scripts/operations/production/daemon-control.ts enable-routing --base-url http://127.0.0.1:8080 --name H1 --seed my-seed --signer-label hub-1
  bun core/scripts/operations/production/daemon-control.ts become-hub --base-url http://127.0.0.1:8080 --name H1 --seed my-seed --signer-label hub-1
  bun core/scripts/operations/production/daemon-control.ts setup-custody --base-url http://127.0.0.1:8080 --name Custody --seed my-seed --signer-label custody-1 --hub-ids 0x...,0x...
