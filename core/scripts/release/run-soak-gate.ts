  ...
  mainnet: [
    {
      ...
      command:
        ...
        'bun core/scripts/operations/benchmark/bench-storage-hub.ts ' +
    ...
    },
    {
      ...
      command: 'bun core/scripts/operations/benchmark/bench-swap-runtime-tps.ts --swaps 1000 --warmup 100 --min-tps 100',
      timeoutMs: 120_000,
    },
    {
      name: 'swap scenarios 100 TPS',
      command: 'bun core/scripts/operations/benchmark/bench-swap-scenarios-tps.ts --swaps 1000 --warmup 100 --min-tps 100',
      timeoutMs: 180_000,
    },
    {
      name: '100-user single-hub-cohort Account consensus 100 TPS',
      command: 'bun core/scripts/operations/benchmark/bench-swap-hub-consensus-tps.ts --swaps 300 --warmup 30 --min-aggregate-account-consensus-tps 100 --batch-size 100 --users 100 --independent-hub-cohorts 1',
      timeoutMs: 240_000,
    },
  ],
};
