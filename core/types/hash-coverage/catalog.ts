...
> & readonly NestedHashCoverageEntry[] = [
  ...
  { typeName: 'HtlcRoute', sourceFile: 'core/types/account.ts', fields: HASHABLE_HTLC_ROUTE_FIELDS, shape: 'interface' },
  { typeName: 'CrossJurisdictionSecretRelay', sourceFile: 'core/types/account.ts', fields: HASHABLE_CROSS_J_SECRET_RELAY_FIELDS, shape: 'interface' },
