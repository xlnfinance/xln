...
export const mergeEntityInputs = (entityInputs) => {
...
export const applyEntityFrame = (env, entityState, entityTxs) => {
...
export const processEntityInput = (env, entityReplica, entityInput) => {
    // Add validation
    if (!entityReplica) {
...
export const processServerInput = (env, serverInput, captureSnapshotFn) => {
...
// === DEMO UTILITY ===
export const processUntilEmpty = (env, inputs, captureSnapshotFn) => {
    let outputs = inputs;
