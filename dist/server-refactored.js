...
let DEBUG = true;
import { generateLazyEntityId, generateNumberedEntityId, generateNamedEntityId, detectEntityType, encodeBoard, hashBoard, resolveEntityIdentifier, isEntityRegistered } from './entity-utils.js';
import { createLazyEntity, createNumberedEntity, requestNamedEntity, transferNameBetweenEntities } from './entity-factory.js';
import { connectToEthereum, registerNumberedEntityOnChain, assignNameOnChain, getEntityInfoFromChain, getNextEntityNumber } from './blockchain.js';
import { DEFAULT_JURISDICTIONS, getAvailableJurisdictions, getJurisdictionByAddress, registerEntityInJurisdiction } from './jurisdictions.js';
import { processServerInput } from './consensus-engine.js';
import { clearDatabase, resetHistory, getHistory, getSnapshot, getCurrentHistoryIndex, loadFromDatabase } from './snapshot-manager.js';
