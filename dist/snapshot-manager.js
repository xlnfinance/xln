...
export const captureSnapshot = (env, serverInput, serverOutputs, description) => {
    const snapshot = {
        height: env.height,
...
export const getSnapshot = (index) => index >= 0 && index < envHistory.length ? envHistory[index] : null;
