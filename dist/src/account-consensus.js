 ...
 */
export function validateAccountFrame(frame) {
    if (frame.frameId < 0)
        return false;
    ...
    if (Math.abs(frame.timestamp - now) > 300000)
        return false; // 5 min drift
    return true;
}
/**
 * Validate message counter (strict replay protection)
 */
export function validateMessageCounter(accountMachine, counter) {
...
function createFrameHash(frame) {
 ...
 */
export function processAccountTx(accountMachine, accountTx, isOurFrame = true) {
 ...
 */
export function proposeAccountFrame(accountMachine) {
 ...
 */
export function handleAccountInput(accountMachine, input) {
 ...
 */
export function addToAccountMempool(accountMachine, accountTx) {
    if (accountMachine.mempool.length >= MEMPOOL_LIMIT) {
 ...
 */
export function shouldProposeFrame(accountMachine) {
 ...
 */
export function getAccountsToProposeFrames(entityState) {
 ...
 */
export function generateAccountProof(accountMachine) {
