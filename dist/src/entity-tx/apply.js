 ...
 */
function getOwnerIdFromEntity(entityId) {
...
export const applyEntityTx = async (env, entityState, entityTx) => {
    ...
    try {
        ...
        if (entityTx.type === 'place_order') {
            ...
            const cmd = {
                ...
                owner,
                orderId,
                side: entityTx.data.side === 'buy' ? 0 : 1,
                tif: 0, // GTC (Good Till Cancel)
                postOnly: false,
                reduceOnly: false,
