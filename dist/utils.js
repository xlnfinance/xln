 ...
 */
export const formatSignerDisplay = (signerId) => {
 ...
 */
export const getSignerDisplayInfo = (signerId) => {
    const signerInfo = DEMO_SIGNERS[signerId];
    if (signerInfo) {
        return {
 ...
 */
export const getSignerAddress = (signerId) => {
    const signerInfo = DEMO_SIGNERS[signerId];
    if (signerInfo) {
 ...
 */
export const generateEntityAvatar = (entityId) => {
    try {
 ...
 * @returns Base64 encoded SVG avatar
 */
export const generateSignerAvatar = (signerId) => {
    try {
