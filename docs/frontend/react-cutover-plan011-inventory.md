...
- `bun run gate:ci` stopped at runtime core tests with 473 pass and 11 fail. Three migration-owned failures were fixed and passed narrowly in `68160cf0b`; the remaining eight failures touch Runtime/Entity/Account semantics and require owner authority before implementation.
