...
- [x] Enforce frontend source file-size invariant in the main check.
  ...
  - Evidence: `bun run check` PASS. Largest frontend files after the split are `EntityPanelTabs.svelte` 4,331 lines, `Graph3DPanel.svelte` 4,238 lines, `SwapPanel.svelte` 4,119 lines, and `/qa/+page.svelte` 3,576 lines.
