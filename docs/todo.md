...
- [x] Enforce frontend source file-size invariant in the main check.
  ...
  - Evidence: `bun run check` PASS. Largest frontend files after the split are `SwapPanel.svelte` 3,898 lines, `EntityPanelTabs.svelte` 3,892 lines, `Graph3DPanel.svelte` 3,842 lines, and `/qa/+page.svelte` 3,576 lines.
