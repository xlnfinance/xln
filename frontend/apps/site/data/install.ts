...
export const INSTALL_CHANNELS: readonly InstallChannel[] = [
  {
    id: 'cli', title: 'Local runtime', label: 'Recommended',
    ...
    tradeoff: 'Requires Bun and a terminal.', href: 'https://www.npmjs.com/package/xlnfinance',
    action: 'Package details', command: LOCAL_RUNTIME_COMMAND,
  },
  {
    id: 'web', title: 'Web', label: 'Instant', summary: 'Open xln immediately. Nothing to install.',
    platforms: ['Any browser'], benefit: 'Fastest way to try the complete app.',
    tradeoff: 'The server can replace the code you receive. This is fundamental and cannot be fixed.',
    href: '/app', action: 'Open xln',
  },
  {
    id: 'desktop', title: 'Desktop', label: 'Electron',
    ...
    href: 'https://github.com/xlnfinance/xln/releases/latest', action: 'Desktop downloads',
  },
  {
    id: 'mobile', title: 'Mobile', label: 'Capacitor',
    summary: 'The same wallet packaged for phone and tablet.', platforms: ['iPhone & iPad', 'Android'],
    ...
    href: 'https://github.com/xlnfinance/xln/releases/latest', action: 'Mobile builds',
  },
  {
    id: 'extension', title: 'Chrome', label: 'Extension',
    summary: 'The complete xln wallet in a Chrome tab.', platforms: ['Google Chrome'],
    ...
    href: 'https://github.com/xlnfinance/xln/releases/latest', action: 'Download extension',
  },
] as const;
