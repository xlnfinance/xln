...
export const WalletTestnetPage = () => (
  <main className="wallet-testnet" data-testid="wallet-testnet-page">
    <header><a className="wallet-wordmark" href="/">xln<span>/testnet</span></a><p>TESTNET · NO REAL FUNDS</p><h1>Bilateral payments,<br />observable end to end.</h1><span>Use the xln wallet against the local test network.</span></header>
