...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    behavior: [
      ...
      'framework-neutral Entity workspace deep-link state, top-level section registry, strict identity/context projection, and compact display',
      'React candidate-only identity-first Entity shell with canonical hash-backed top-level tabs and an explicit unattached Runtime boundary',
