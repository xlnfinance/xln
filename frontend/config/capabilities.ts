...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/scripts/deployment-candidate.ts',
      'frontend/scripts/deployment-candidate-smoke-server.ts',
    ],
    behavior: [
      'deep links',
  ...
  },
  {
    ...
    currentSources: [
      ...
      'frontend/apps/ops/src/ops-quorum-chart.tsx',
      'frontend/apps/ops/src/ops-quorum-evidence.tsx',
  ...
  },
  {
    ...
    behavior: [
      ...
      'framework-neutral Entity workspace deep-link state, top-level section registry, strict identity/context, committed-board, paged Account frame-header, and public profile projections',
      'React candidate-only identity-first Entity shell with canonical hash-backed tabs, a tab-confined remote Runtime read boundary, and read-only Ownership, Accounts, and profile evidence',
