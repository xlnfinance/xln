...
export const CAPABILITIES = [
  ...
  },
  {
    ...
    behavior: [
      ...
      'framework-neutral Entity workspace deep-link state, top-level section registry, strict identity/context and committed-board projections, and compact display',
      'React candidate-only identity-first Entity shell with canonical hash-backed tabs, a tab-confined remote Runtime read boundary, and read-only Ownership evidence',
