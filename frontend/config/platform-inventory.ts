...
export const PLATFORM_INVENTORY = [
  ...
  },
  {
    ...
    sources: [
      ...
      'scripts/native/capacitor-shell-candidate-manifest.ts',
      'scripts/native/packaged-shell-candidate-manifest.ts',
      'scripts/native/packaged-shell-policy.ts',
      'scripts/native/regular-tree.ts',
    ],
    consumers: [
    ...
    evidence: [
      ...
      'native/__tests__/capacitor-shell-candidate.test.ts',
  ...
  },
  {
    ...
    workPackage: 'WP8',
    status: 'implemented',
    interfaces: ['release-artifact', 'verification-command'],
    sources: [
      'frontend/scripts/candidate-release.ts',
    ...
    consumers: [
      ...
      'frontend/scripts/deployment-candidate-cli.ts',
    ...
    evidence: [
      ...
      'native/__tests__/capacitor-shell-candidate.test.ts',
      'native/__tests__/packaged-shell-candidate.test.ts',
      'tests/frontend/tooling/frontend-deployment-candidate.test.ts',
  ...
  },
  {
    ...
    workPackage: 'WP10',
    status: 'owned-for-later-wp',
    interfaces: ['desktop-shell', 'extension-shell', 'release-artifact'],
    sources: [
      'frontend/scripts/candidate-release.ts',
      'frontend/scripts/candidate-release-verifier.ts',
    ],
