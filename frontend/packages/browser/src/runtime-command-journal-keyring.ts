...
import { buildRuntimeAdapterOwnerBindingDigest } from '@xln/core/api/runtime-adapter/security/owner-binding';
import { normalizeRuntimeId } from './runtime-command-intent-codec';
