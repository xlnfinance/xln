...
import AccountWorkspaceView from "./workspace/AccountWorkspaceView.svelte";
...
import EntityPanelChrome from "./workspace/EntityPanelChrome.svelte";
import EntityPanelHeroTabs from "./workspace/EntityPanelHeroTabs.svelte";
import EntityPanelShell from "./workspace/EntityPanelShell.svelte";
