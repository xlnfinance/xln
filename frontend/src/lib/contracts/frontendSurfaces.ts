...
export const FRONTEND_ROUTES: readonly FrontendRoute[] = Object.freeze([
  ...
  page('wallet-address-index', '/address', 'wallet', 'index.html', { native: true, pwa: true }),
  page('wallet-address-detail', '/address/:entityId', 'wallet', 'index.html', { native: true, pwa: true }),
  page('wallet-testnet', '/testnet', 'wallet', 'index.html', { native: true, pwa: true }),
  ...
  page('ops-health', '/health', 'ops', 'index.html'),
  page('ops-qa', '/qa', 'ops', 'index.html'),
  page('ops-runs', '/runs', 'ops', 'index.html'),
  page('ops-scenarios', '/scenarios', 'ops', 'index.html'),
  page('ops-ai', '/ai/:chatId?', 'ops', 'index.html'),
  page('ops-embed', '/embed', 'ops', 'index.html'),
