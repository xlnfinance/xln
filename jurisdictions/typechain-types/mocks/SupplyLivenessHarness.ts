...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface SupplyLivenessHarnessInterface extends Interface {
    getFunction(nameOrSignature: "mode" | "setMode" | "totalSupply"): FunctionFragment;

    

    encodeFunctionData(functionFragment: 'mode', values?: undefined): string;
encodeFunctionData(functionFragment: 'setMode', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'totalSupply', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    setMode: TypedContractMethod<
      [nextMode: BigNumberish, ],
      [void],
      'nonpayable'
    >
    ...
    getFunction(nameOrSignature: 'mode'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'setMode'): TypedContractMethod<
      [nextMode: BigNumberish, ],
      [void],
      'nonpayable'
    >;
