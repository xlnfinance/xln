...
|---|---|---|
| [Migration work plan](react-frontend-migration.md) | `IN PROGRESS — WP0–WP6 COMPLETE; WP7 HEALTH/QA/HLT/RUNS/SCENARIOS/AI IMPLEMENTED, WORKSPACE STATE LAYER SVELTE-FREE, PANEL PORTS THROUGH ARCHITECT, REACT DOCKVIEW WRAPPER READY, GRAPH3D SHARED MECHANICS EXTRACTED, ENTITY WORKSPACE REACT SHELL/TABS + LIVE CONTEXT + READ-ONLY OWNERSHIP/ACCOUNTS/PROFILE READY; WP8 CAPACITOR COPY + PWA LIFECYCLE READY` | Verify disposable desktop and extension candidates without packaging or activation. |
