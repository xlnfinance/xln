...
pub struct AccountsCheckpoint {
    /// The revision the last committed checkpoint took the database to.
    pub base_revision: u64,
    /// The revision this checkpoint takes it to, and the only revision
    /// `commit_checkpoint` will accept for it.
    pub revision: u64,
...
impl std::fmt::Debug for AccountsCheckpoint {
    ...
    fn fmt(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        formatter
            ...
            .field("baseRevision", &self.base_revision)
