...
const ENTITY_FRAME_GOLDEN_HASH = '0x799d52ae17f46791332064ca6ca7d1291e5a71b403c7321c1d52cf9df25c4bb5';
...
describe('frame hash golden fixtures', () => {
  ...
  test('receiving Entity frame commits exact external settlement Hanko bytes in one round', () => {
