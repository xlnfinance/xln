...
describe('WebSocket trusted decode boundary', () => {
  test('pins every canonical envelope variant to an independent golden hash', () => {
    const variants = {
      ...
      entity_input: { type: 'entity_input', from: 'a', to: 'b', payload: 'cipher', encrypted: true },
    ...
    const expected = {
      ...
      entity_input: '0x5780d6719f6eb5669c50f3af3773bb243085fcbe8ed857c0d0676656bd8ab392',
  ...
  test.each([
    ...
    ['missing encrypted entity payload', { type: 'entity_input', from: 'a', to: 'b', encrypted: true }],
