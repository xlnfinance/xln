 ...
 *
 * Usage:
 *   bun runtime/api/server/cli.ts                    # local anvil
 *   bun runtime/api/server/cli.ts remote             # xln.finance/rpc
 */
...
import { loadCliJurisdiction, type CliJurisdiction } from '../../jurisdiction/adapter/core/cli-jurisdiction';
