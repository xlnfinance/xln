...
const DOUBLE_ASSERTION_DEBT: Readonly<Record<string, number>> = {
  ...
  'runtime/server/token-catalog.ts': 2,
  ...
  'runtime/wal/runtime-machine-schema/entity-tx.ts': 1,
  'runtime/wal/runtime-machine-schema/index.ts': 1,
  'runtime/wal/runtime-machine-schema/j-observation.ts': 1,
  'runtime/wal/runtime-machine-schema/j.ts': 3,
  'runtime/wal/runtime-machine-schema/runtime-tx.ts': 1,
