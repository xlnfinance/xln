...
const RUNTIME_CORE_TESTS = [
  ...
  'runtime/__tests__/storage/recovery/storage-crash-recovery.test.ts',
  'runtime/__tests__/storage/history/storage-frame-journal-retention.test.ts',
  ...
  'runtime/__tests__/network/p2p/p2p-connect-idempotent.test.ts',
  'runtime/__tests__/network/p2p/p2p-direct-policy.test.ts',
  'runtime/__tests__/security/dispute/proof-builder.test.ts',
  'runtime/__tests__/security/authority/transformer-ordering.test.ts',
  'runtime/__tests__/network/server/server-ingress-receipts.test.ts',
  'runtime/__tests__/orchestrator/health/orchestrator-health-model.test.ts',
  'runtime/__tests__/orchestrator/recovery/orchestrator-reset-guard.test.ts',
  'runtime/__tests__/jurisdiction/history/jreplica-state-root.test.ts',
  'runtime/__tests__/storage/recovery/persistence-inspect.test.ts',
