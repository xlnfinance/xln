...
const RUNTIME_CORE_TESTS = [
  ...
  'runtime/__tests__/cross-jurisdiction-fill-zero-cancel.test.ts',
  'runtime/__tests__/cross-jurisdiction-security.test.ts',
  'runtime/__tests__/cross-j-boundary.test.ts',
  'runtime/__tests__/runtime-scheduled-wake.test.ts',
  'runtime/__tests__/storage-progress-deadline.test.ts',
  'runtime/__tests__/jadapter-stack-binding.test.ts',
  'runtime/__tests__/jadapter-static-network.test.ts',
  'runtime/__tests__/orchestrator-jurisdiction-provisioning.test.ts',
  ...
  'runtime/__tests__/persistence-inspect.test.ts',
