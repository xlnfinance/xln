...
import { AccountDelta, AccountMachine } from './types';
...
export function deriveDelta(
  ...
  ownCreditLimit: bigint,
  peerCreditLimit: bigint,
  isCounterpartyView: boolean = false
): DerivedDelta {
  ...
  let inCapacity = nonNegative(
    inOwnCredit + inCollateral + inPeerCredit - inAllowance
  );
  let outCapacity = nonNegative(
    outPeerCredit + outCollateral + outOwnCredit - outAllowance
  );
 ...
 */
export function getAccountCapacity(
  account: AccountMachine,
  tokenId: number,
  fromCounterpartyView: boolean = false
): DerivedDelta | null {
 ...
 */
export function calculateMaxPayment(
  account: AccountMachine,
  tokenId: number,
 ...
 */
export function visualizeDelta(derived: DerivedDelta): string {
