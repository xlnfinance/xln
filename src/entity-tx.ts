        ...
        switch (event.type) {
          ...
          case 'reserveToReserve': {
            ...
            if (!to || from === to) {
              ...
              // NOTE: This is a transfer between entities placeholder
              // TODO: Implement proper transfer between entities
          ...
          case 'ControlSharesTransferred':
            subtractFromReserves(
              newEntityState.reserves,
              `share-${event.data.internalTokenId}`,
              BigInt(event.data.amount),
            );
