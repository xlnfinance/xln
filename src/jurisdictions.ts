...
export const generateJurisdictions = (): Map<string, JurisdictionConfig> => {
...
export const getAvailableJurisdictions = (): JurisdictionConfig[] => {
  return Array.from(DEFAULT_JURISDICTIONS.values());
};

export const getJurisdictionByAddress = (address: string): JurisdictionConfig | undefined => {
  return DEFAULT_JURISDICTIONS.get(address);
};

export const registerEntityInJurisdiction = async (
  entityId: string,
