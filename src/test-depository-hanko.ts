...
const testMixedHanko = async () => {
  ...
  try {
    ...
    console.log('ℹ️  Mixed Hanko test failed as expected (entity verification):', (error instanceof Error ? error.message : String(error)).substring(0, 100));
...
const testInvalidSignatures = async () => {
  ...
  try {
    ...
    console.log('✅ Invalid signatures correctly rejected:', (error instanceof Error ? error.message : String(error)).substring(0, 100));
    return true;
  }
};
...
const testWrongNonce = async () => {
  ...
  try {
    ...
    console.log('✅ Wrong nonce correctly rejected:', (error instanceof Error ? error.message : String(error)).substring(0, 100));
    return true;
  }
};
...
const testDomainSeparation = async () => {
  ...
  try {
    ...
    console.log('✅ Domain separation correctly prevented replay:', (error instanceof Error ? error.message : String(error)).substring(0, 100));
    return true;
  }
};
