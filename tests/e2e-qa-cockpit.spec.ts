...
const QA_CATALOG = [
  {
    ...
    command: 'bun core/scripts/e2e/runners/run-e2e-parallel-isolated.ts --all --video=on',
  ...
  },
  {
    ...
    command: 'bun test core/__tests__',
...
const QA_STORIES = [
  ...
  qaFixtureStory(
    'desktop-swap-route-selected.png',
    'desktop swap route selection',
    'Swap',
    'Swap ticket after selecting a destination route.',
    'desktop',
    ['swap', 'route'],
  ),
  qaFixtureStory(
    'mobile-swap-route-selected.png',
    'mobile swap route selection',
    'Swap',
    'Mobile swap ticket after selecting a destination route.',
    'mobile',
    ['swap', 'route'],
  ),
  qaFixtureStory(
  ...
  qaFixtureStory(
    'desktop-swap-token-selected.png',
    'desktop swap token selection',
    'Swap',
    'Swap ticket after selecting the asset to sell.',
    'desktop',
    ['swap', 'token'],
  ),
  qaFixtureStory(
    'mobile-swap-token-selected.png',
    'mobile swap token selection',
    'Swap',
    'Mobile swap ticket after selecting the asset to sell.',
    'mobile',
    ['swap', 'token'],
  ),
  qaFixtureStory(
