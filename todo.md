...
- [ ] Split remaining god-functions by protocol phase and failure boundary:
  ...
  baseline (excluding tests, QA, scenarios and scripts): 64 functions over
  150 lines after splitting the reserve-faucet and credit-request pipelines. Start with
